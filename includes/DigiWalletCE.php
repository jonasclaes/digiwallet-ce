...
class DigiWalletCE {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/DigiWalletCELoader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/DigiWalletCEi18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/DigiWalletCEAdmin.php';
	...
	private function set_locale() {
		...
		$plugin_i18n = new DigiWalletCEi18n();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new DigiWalletCEPublic( $this->get_plugin_name(), $this->get_version() );
